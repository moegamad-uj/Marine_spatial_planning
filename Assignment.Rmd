...
```{r}
# Create table of estuary scores
...
# Remove old summary rows if this is re-run
estuary_table <- estuary_table[!rownames(estuary_table) %in% c("Species Protected", "Percent Protected"), ]

# Create the two summary rows as data frames
...
# Rename the last two rows
n <- nrow(estuary_table)
rownames(estuary_table)[(n-1):n] <- c("Species Protected", "Percent Protected")
